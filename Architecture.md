...
> **Enhanced Claude Code configuration generator with context-aware intelligence**
...
export async function collectProjectGoal(): Promise<ProjectGoal> {
  const intro = p.intro("SuperAgents - Context-Aware Configuration Generator");
...
│    ✓ frontend-engineer.md (context-aware)                         │
│    ✓ backend-engineer.md (context-aware)                          │
│    ✓ reviewer.md                                               │
...
### Agent File Format (Context-Aware)
