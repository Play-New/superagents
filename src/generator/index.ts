...
`;
   ...
   */
  private generateArchitectureDoc(context: GenerationContext): DocOutput {
...
`;
   ...
   */
  private generatePatternsDoc(context: GenerationContext): DocOutput {
    const { codebase } = context;
...
`;
   ...
   */
  private generateSetupDoc(context: GenerationContext): DocOutput {
    const { codebase } = context;
