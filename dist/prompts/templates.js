 ...
 */
export function summarizeFile(content, filename) {
    ...
    if (imports.length > 0) {
        ...
        if (imports.length > 10)
            summary.push(`// ... ${imports.length - 10} more imports`);
    }
    // Extract exports
    ...
    if (exports.length > 0) {
        ...
        if (exports.length > 15)
            summary.push(`// ... ${exports.length - 15} more exports`);
    }
    // Extract function/class signatures (non-exported)
    const signatures = lines.filter(l => (l.trim().startsWith('function ') ||
 ...
 */
export function buildSamplesSection(context, maxFiles = 3) {
